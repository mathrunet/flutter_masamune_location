...
class MapStyle {
  ...
  /// Define the map style.
  ///
  /// You can define a map style by applying a map style json text to [style].
  const MapStyle(String style)
      : assert(style != null),
        this._style = style;
    ...
    "stylers": [
      {
        ...
        : "";
    return MapStyle("""[$label]""");
  }

  /// Define the map style.
  ///
  /// Silver map style.
  factory MapStyle.silver([bool hiddenLabel = false]) {
    final label = hiddenLabel
        ? """{
    "elementType": "labels.icon",
    "stylers": [
